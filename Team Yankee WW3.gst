  ...
  <profileTypes>
    ...
    <profileType id="de02-a834-ba11-b332" name="Infantry Team">
      ...
      <characteristicTypes>
        ...
        <characteristicType id="ed89-96f8-45b7-26ca" name="Morale"/>
        <characteristicType id="c81e-82ec-8fdc-e713" name="Rally"/>
        <characteristicType id="f658-164f-55f0-0e6d" name="Skill"/>
        <characteristicType id="1b97-b8e9-93a4-fedf" name="Assault"/>
        <characteristicType id="a9cc-2305-182f-cd0b" name="Counter Attack"/>
    ...
    <profileType id="28dc-0c96-453a-604f" name="Tank Unit">
      ...
      <characteristicTypes>
        ...
        <characteristicType id="4950-fc13-3dd2-45a4" name="Morale"/>
        <characteristicType id="937b-a520-deb0-89f9" name="Remount"/>
        <characteristicType id="77c7-e659-4a0c-a38f" name="Skill"/>
        <characteristicType id="6efe-9ae5-127f-70cf" name="Assault"/>
        <characteristicType id="0caf-c884-e5b8-0cf0" name="Counterattack"/>
    ...
    <profileType id="973a-aa06-b137-2f9e" name="Unarmored Tank Unit">
      ...
      <characteristicTypes>
        ...
        <characteristicType id="0ada-75a5-d97c-27ab" name="Morale"/>
        <characteristicType id="e3db-8480-b84f-e5d2" name="Rally"/>
        <characteristicType id="ef6b-6ca3-15b2-d564" name="Skill"/>
        <characteristicType id="de60-c7f5-0e2f-c396" name="Assault"/>
        <characteristicType id="25f5-40ee-c362-bef3" name="Counterattack"/>
    ...
    <profileType id="e9be-b9e3-7b99-9c51" name="Weapons">
      <comment>NEW</comment>
      <characteristicTypes>
        <characteristicType id="224f-dd7c-9266-b9b2" name="Range"/>
        <characteristicType id="9ed0-82b4-8515-e261" name="Halted ROF "/>
        <characteristicType id="a103-8ee9-3848-1e04" name="Moving ROF "/>
...
All Strike Aircraft are removed from the table at the end of the Shooting Step. Any casualties they suffer carry over when the Unit returns to the table. </description>
    ...
    <rule id="2037-79f0-8461-6a15" name="Slow Firing" hidden="false">
...
When Deploying their remaining Units, a player may trreat the area entirely within 8&quot;/20CM of a Spearhead Team that is In Command as an extension of their Deployment Area. Teams placed here may not be placed in the areas that a Spearhead Team may not move into.</description>
    ...
    <rule id="a5b9-484d-9c48-b035" name="Passengers 2" hidden="false">
      <description>A Transport Team can carry 2 Infantry Teams as Passengers. </description>
    </rule>
    <rule id="a278-4160-81c9-3665" name="Passengers 3" hidden="false">
      <description>A Transport Team can carry 3 Infantry Teams as Passengers. </description>
    </rule>
    <rule id="bb9d-7f42-7b00-a932" name="Passengers 4" hidden="false">
    ...
    <rule id="d6a7-6e50-b25c-5811" name="MLRS (American)" hidden="false">
